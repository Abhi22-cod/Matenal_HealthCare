...
We developed an IoT-driven predictive system using machine learning and deep learning techniques:

🔄 Workflow
Data Collection
1.IoT sensors collect:
  Age
...
📌 Conclusion
    This system provides an intelligent, real-time solution for maternal healthcare by combining IoT and deep learning. It helps in early risk detection, improves     healthcare outcomes, and reduces maternal mortality.
